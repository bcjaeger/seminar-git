...
<iframe src="https://app.sli.do/event/hvo96l22" height="90%" width="110%" frameBorder="0" style="min-height: 560px;" title="Slido"></iframe>
...
# The default branch name in git is .blue[master]
...
# When you are happy with the changes you made in a branch, you need a way to get those changes back into the master branch.
...
# This positions you to request that the repo owner to merge a branch of your forked repo into their master branch, i.e., a .blue[pull request].
...
---
background-image: url(img/file_management_35.png)
background-size: 100%
...
---
background-image: url(img/file_management_39.png)
background-size: 100%
...
# .larger[.rainbow-text[BONUS ROUND]]
